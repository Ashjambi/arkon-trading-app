...
void ManageCapitalRecovery() {
    ...
    // Dynamic Zombie Basket criteria (BSS drops below threshold or extreme sustained floating loss)
    g_IsZombieBuy = (buyCount >= 5 && buyFloatingPnL < -2000.0);
    g_IsZombieSell = (sellCount >= 5 && sellFloatingPnL < -2000.0);
